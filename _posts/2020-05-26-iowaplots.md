...
I grew up in Kansas City and went to grad school in the midwest to study chemistry using simulation data.

Because I was in theory, alot of the methods we were developing required significant benchmarking of our 'theoretical' value to:
...
Interpretation as you can imagine was very tedious as we were generally scanning over numerical data organized in tabular spreadsheets. Sometimes we were able to pick up on trends and correlation - but in the end scanning over numerical data wasn't an efficient means of analyze.
